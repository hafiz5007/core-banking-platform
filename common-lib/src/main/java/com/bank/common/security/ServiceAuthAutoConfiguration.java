...
public class ServiceAuthAutoConfiguration {
    ...
    public ServiceAuthProperties serviceAuthProperties(
        ...
        return new ServiceAuthProperties(true, secret, serviceName, issuer, serviceName,
                Duration.ofSeconds(tokenTtlSeconds), Duration.ofSeconds(clockSkewSeconds));
    }
    ...
    public FilterRegistrationBean<ServiceTokenAuthFilter> serviceTokenAuthFilter(ServiceTokenVerifier verifier) {
