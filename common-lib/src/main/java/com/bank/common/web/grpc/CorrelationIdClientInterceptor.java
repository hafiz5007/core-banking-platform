 ...
 * transport with its own metadata: without this interceptor the id stops at the service boundary and
 * a request can only be followed into ledger-service by matching on entry id or narrative. The
