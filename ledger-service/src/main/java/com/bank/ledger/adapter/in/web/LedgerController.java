...
public class LedgerController {
  ...
  public ResponseEntity<LedgerAccountResponse> createAccount(
    ...
    return ResponseEntity.created(URI.create("/api/v1/ledger/accounts/" + account.getCode()))
  ...
  public ResponseEntity<JournalEntryResponse> post(@Valid @RequestBody PostEntryRequest request) {
    ...
    return ResponseEntity.created(URI.create("/api/v1/ledger/entries/" + entry.getId()))
  ...
  public ResponseEntity<JournalEntryResponse> reverse(
    ...
    return ResponseEntity.created(URI.create("/api/v1/ledger/entries/" + reversal.getId()))
