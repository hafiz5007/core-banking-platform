...
public class JournalEntry {
    ...
    private JournalEntry(String idempotencyKey, String narrative, LocalDate valueDate,
                         List<JournalLine> lines, UUID reversalOfId) {
    ...
    public static JournalEntry post(String idempotencyKey, String narrative,
                                    LocalDate valueDate, List<JournalLine> lines) {
    ...
    public JournalEntry reversal(String idempotencyKey, List<JournalLine> reversedLines) {
        return new JournalEntry(idempotencyKey,
                "Reversal of " + this.id, LocalDate.now(), reversedLines, this.id);
    }
    ...
    /**
     * Enforce the double-entry invariant. Public and static so it is trivially unit-testable
     * without a database.
     */
