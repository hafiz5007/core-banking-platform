...
/**
 * A node in the chart of accounts. The running {@code balance} is held in debit-positive terms (sum
 * of debits minus sum of credits); {@link #normalBalance()} flips the sign for credit-normal
