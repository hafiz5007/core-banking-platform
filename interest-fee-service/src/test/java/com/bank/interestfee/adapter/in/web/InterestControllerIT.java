...
class InterestControllerIT extends AbstractIntegrationTest {
  ...
  void opensAccruesAndCapitalizes() {
    ...
    ResponseEntity<PositionResponse> accrued =
        rest.postForEntity(
            "/api/v1/interest/positions/" + account + "/accrue?upTo=" + upTo,
            null,
    ...
    ResponseEntity<PositionResponse> capitalized =
        rest.postForEntity(
    ...
    assertThat(new BigDecimal(capitalized.getBody().principal()))
