-- ADR-002 (tenancy) + ADR-001 (change history) rollout for risk-aml-service.

ALTER TABLE aml_case ADD COLUMN organization_id VARCHAR(60) NOT NULL DEFAULT 'DEFAULT';
CREATE INDEX idx_aml_case_organization ON aml_case (organization_id);
