-- ADR-002 (tenancy) + ADR-001 (change history) rollout for notification-service.

ALTER TABLE notification ADD COLUMN organization_id VARCHAR(60) NOT NULL DEFAULT 'DEFAULT';
