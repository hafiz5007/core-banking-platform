-- ADR-002 (tenancy) + ADR-001 (change history) rollout for payment-service.

ALTER TABLE payment ADD COLUMN organization_id VARCHAR(60) NOT NULL DEFAULT 'DEFAULT';
CREATE INDEX idx_payment_organization ON payment (organization_id);
