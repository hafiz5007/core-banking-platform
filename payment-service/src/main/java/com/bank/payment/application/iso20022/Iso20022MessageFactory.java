...
public class Iso20022MessageFactory {
  ...
  /**
   * Build a pacs.008 with an explicit interbank settlement amount — used for cross-border transfers
   * where the amount sent to the correspondent is the FX-converted target amount.
   */
