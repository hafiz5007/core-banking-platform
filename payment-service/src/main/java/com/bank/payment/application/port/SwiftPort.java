...
/**
 * Outbound port to the SWIFT / cross-border network. Submits an ISO 20022 message for an
 * interbank settlement amount in the beneficiary currency and returns the network acknowledgement
 * (a gpi-style reference for end-to-end tracking).
 */
