...
/**
 * Thrown by a rail handler when fulfilment fails <em>after</em> the ledger has posted, having already
 * reversed it. Carries the compensating reversal entry id so the orchestrator can record a clean
 * COMPENSATED outcome.
 */
