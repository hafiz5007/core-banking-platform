 ...
 * movement (ledger posting) and any external scheme submission, mutating the {@link Payment}
 * through its lifecycle. If fulfilment fails after the ledger has posted, the handler reverses the
 * posting and throws {@link PaymentRailException}.
 */
