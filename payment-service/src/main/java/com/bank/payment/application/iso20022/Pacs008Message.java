 ...
 * can render a representative XML payload; a production build would marshal against the official XSD.
 *
...
public record Pacs008Message(
    ...
    public String toXml() {
        return """
                ...
                .formatted(messageId, creationDateTime, uetr, currency,
                        amount.toPlainString(), debtorAccount, creditorAccount,
