 ...
 *
 * <ol>
 *   <li>obtains an FX quote and converts the source amount to the beneficiary currency;
 *   <li>posts the money movement to the ledger — debit the customer, credit the nostro account (our
 *       account at the correspondent), in the source currency;
 ...
 *       so the saga records a COMPENSATED outcome.
 * </ol>
 *
...
public class CrossBorderHandler implements PaymentRailHandler {
  ...
  public void execute(Payment payment) {
    ...
    String targetCurrency =
        payment.getTargetCurrencyCode() != null ? payment.getTargetCurrencyCode() : sourceCurrency;
