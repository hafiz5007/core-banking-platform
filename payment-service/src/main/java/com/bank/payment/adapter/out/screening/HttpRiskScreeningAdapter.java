 ...
 * non-ALLOW decision (HOLD/DECLINE) is treated as a screening hold. Enabled with {@code
 * screening.adapter=risk-service}. If the risk service is unreachable the call fails fast and the
 * payment is rejected — payments are never allowed to bypass screening silently.
 */
@Component
...
public class HttpRiskScreeningAdapter implements ScreeningPort {
  ...
  public HttpRiskScreeningAdapter(
