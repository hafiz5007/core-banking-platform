 ...
 * containing "BLOCKED" (case insensitive) produces a hold; everything else clears. Set {@code
 * screening.adapter=risk-service} to call the real risk-aml-service instead.
 */
@Component
