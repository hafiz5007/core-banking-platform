-- ADR-002 (tenancy) + ADR-001 (change history) rollout for customer-service.

ALTER TABLE customer ADD COLUMN organization_id VARCHAR(60) NOT NULL DEFAULT 'DEFAULT';
CREATE INDEX idx_customer_organization ON customer (organization_id);
