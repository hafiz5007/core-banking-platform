...
public record CustomerResponse(
    ...
    public static CustomerResponse from(Customer c) {
        return new CustomerResponse(
                c.getId(), c.getOrganizationId(), c.getCif(), c.getFirstName(), c.getLastName(),
                c.getNationality(), c.getEmail(), c.getStatus(), c.getKycStatus(), c.isScreeningMatch(),
                c.getRiskRating(), c.getKycRefreshDue(), c.getCreatedAt());
    }
}
