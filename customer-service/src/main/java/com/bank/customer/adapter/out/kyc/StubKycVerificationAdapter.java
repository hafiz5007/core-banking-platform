 ...
 * external call so the onboarding flow is fully exercisable end-to-end:
 * a surname of "REFER" returns REFERRED, "FAIL" returns FAILED, everything else VERIFIED.
 *
...
public class StubKycVerificationAdapter implements KycVerificationPort {
    ...
    public KycVerificationResult verify(KycVerificationRequest request) {
        ...
        KycStatus status = switch (surname) {
