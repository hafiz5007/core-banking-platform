...
class CustomerControllerIT extends AbstractIntegrationTest {
    ...
    private OnboardCustomerRequest request(String lastName) {
        return new OnboardCustomerRequest("Ada", lastName, LocalDate.of(1990, 1, 1),
    ...
    void invalidNationalityIsRejected() {
        var bad = new OnboardCustomerRequest("Ada", "Lovelace", LocalDate.of(1990, 1, 1),
                "GBR", "ada@example.com", null, null, true, "WEB");
        ResponseEntity<String> response =
                rest.postForEntity("/api/v1/customers", bad, String.class);
