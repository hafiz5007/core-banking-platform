...
class CustomerServiceTest {
    ...
    void setUp() {
        ...
        service = new CustomerService(customerRepository, consentRepository, kycPort, screeningPort, changeLog);
    ...
    private OnboardCommand command() {
        return new OnboardCommand("Ada", "Lovelace", LocalDate.of(1990, 1, 1),
