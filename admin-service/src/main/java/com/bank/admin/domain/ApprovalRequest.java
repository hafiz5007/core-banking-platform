...
/**
 * A maker-checker (four-eyes) approval request (FR-BO-002): one user (the maker) submits a sensitive
 * action; a different user (the checker) must approve or reject it. The same person can never do
 * both.
 */
@Entity
