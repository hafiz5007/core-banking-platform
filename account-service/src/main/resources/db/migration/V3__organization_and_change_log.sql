-- ADR-002 (tenancy) + ADR-001 (change history): organization scoping and per-entity change log.
-- Reference implementation for account-service; replicate across services.

ALTER TABLE account ADD COLUMN organization_id VARCHAR(60) NOT NULL DEFAULT 'DEFAULT';
