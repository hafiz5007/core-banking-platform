 ...
 * currency code — never a floating-point column — and exposed to the rest of the system as a {@link
 * Money} value object. Optimistic locking ({@link Version}) guards concurrent updates.
 */
@Entity
@Table(name = "account")
public class Account {
  ...
  public static Account openFromProduct(
      String organizationId,
      UUID customerId,
      String accountNumber,
      Product product,
