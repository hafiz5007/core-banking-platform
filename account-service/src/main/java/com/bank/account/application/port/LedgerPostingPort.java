 ...
 *
 * <p>A debit of a customer account is one half of a balanced entry: the customer's
 * deposit-liability account is debited and a settlement account is credited. Implementations are
 * config-switched via {@code ledger.posting} — a no-op by default, gRPC to ledger-service in a
 * wired deployment (ADR-007).
 */
