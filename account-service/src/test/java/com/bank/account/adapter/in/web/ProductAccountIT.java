...
class ProductAccountIT extends AbstractIntegrationTest {
  ...
  void createsProductAndOpensJointAccountFromIt() {
    ...
    OpenFromProductRequest open =
        new OpenFromProductRequest(code, primary, List.of(joint), MandateType.JOINT);
    ...
    ResponseEntity<List<AccountHolderResponse>> holders =
        rest.exchange(
            "/api/v1/accounts/" + body.id() + "/holders",
            HttpMethod.GET,
            null,
